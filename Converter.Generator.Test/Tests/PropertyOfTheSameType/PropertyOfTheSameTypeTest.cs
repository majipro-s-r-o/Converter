using Majipro.Converter.Generator.Test.Tests.PropertyOfTheSameType;

namespace Majipro.Converter.Generator.Test.Tests.PropertyOfTheSameType;
...
public class PropertyOfTheSameTypeTest : ConversionTestBase<PropertyOfTheSameTypeComposition>
{
    public PropertyOfTheSameTypeTest()
        : base(@".\Tests\PropertyOfTheSameType\PropertyOfTheSameTypeComposition.cs")
    {
    }
